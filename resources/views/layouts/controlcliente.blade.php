        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('apiproductos.index') }}">{{ __('Ver productos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('apipedidos.index') }}">{{ __('Hacer Pedido') }}</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('apiusers.edit', Auth::id()) }}">
                                    {{ __('Editar mis datos') }}
                                </a>
